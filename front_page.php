<!-- <div  id="owl" class="owlMainSlider">
                    <div>
        <a href="#">
            <img src="img/slider-post-1.jpg" class="img-responsive" alt=""/>
            <div class="picture-caption-fixed">
            <h2 class="margin-top-5 margin-bottom-5 font-weight-200">Parlamento catalán declara la independencia de la región</h2>
       </div>
        </a>
    </div>
                                        <div>
        <a href="#">
            <img src="img/slider-post-2.jpg" class="img-responsive" alt=""/>
            <div class="picture-caption-fixed">
            <h2 class="margin-top-5 margin-bottom-5 font-weight-200">Parlamento catalán declara la independencia de la región</h2>
          </div>
        </a>
                                        ...
                                        <div>
        <a href="#">
            <img src="img/slider-post-3.jpg" class="img-responsive" alt=""/>
            <div class="picture-caption-fixed">
            <h2 class="margin-top-5 margin-bottom-5 font-weight-200">Parlamento catalán declara la independencia de la región</h2>
         </div>
        </a>
                                        ...
                                        <div>
        <a href="#">
            <img src="img/slider-post-4.jpg" class="img-responsive" alt=""/>
            <div class="picture-caption-fixed">
            <h2 class="margin-top-5 margin-bottom-5 font-weight-200">Parlamento catalán declara la independencia de la región</h2>
           </div>
        </a>
